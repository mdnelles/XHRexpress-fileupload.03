...
export const Media = () => {
    ...
    const loadHandler = event =>{
        ...
        setMsg(resMsg);
        console.log('loadHandler: ' + event.target.responseText);
    ...
    const errorHandler = event => {
        ...
        console.log('errorHandler: ' + event.target.responseText);
    }
...
const startUploadFile = e => {
    ...
    const onChangeHandler = event => {
        ...
        } else if (mime === undefined || (!mime.includes('image') && !mime.includes('video') && !mime.includes('audio') ) ) {
            setAlertColor('danger');
            ...
            <Alert color="primary">
                <div id="formWrapper">
                    <form  encType="multipart/form-data" method="post">
                        ...
                        <input type="file" name="file" id="file" onChange={onChangeHandler} className="fileUp" />
                        <input type="hidden" name="file_size" value={fileSize}/>
                        <div className={viewProgress}>
                            <div className="text-center">{uploadRunning} of {uploadTotal} - ({percentComplete}%)</div>
